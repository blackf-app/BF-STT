...
2. Generate a concise and descriptive commit message based on the staged changes. I will review the `git diff --cached` output to understand the context of your work.
